export const SendToken = () => {
  return (
    <section
      id="easiest_send_cryptocurrencies"
      className="text-white flex py-28 justify-around max-w-[1500px] px-[30px] mx-auto"
    >
      <svg
      ...
      <div className="lg:flex lg:flex-col lg:justify-center lg:items-start lg:m-auto lg:w-1/3 lg:space-y-4 z-50">
        <h2 className="font-extrabold p-5 text-4xl ">
          Send <span className="text-azoxo"> NEAR </span> and{" "}
          <span className="text-azoxo"> NEP-141</span> tokens directly on
          discord.
        </h2>
        <img
        ...
        <button
          className="flex items-center text-white rounded-full  mx-auto px-5  py-2 text-xl  justify-between
                bg-button lg:mx-0 lg:mr-auto lg:my-4 align-middle"
          type="button"
        >
