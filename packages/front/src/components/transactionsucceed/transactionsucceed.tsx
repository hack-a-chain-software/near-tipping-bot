  ...
  return (
    <div className="flex bg-grey font-sans  text-white flex-col mb-0 pb-0 items-stretch ">
      <div className="flex flex-col lg:flex-row justify-center text-center items-center   min-h-screen">
        <img src="\images\tipping_bot_transaction_succeed.png" className="mx-0 pr-0" alt='tipping bot happy'> </img>
          ...
          <div className="text-start py-0 my-0">
            ...
            <div className=" mb-8">
              <form className="flex flex-row p-0.5">
                <p className="font-normal text-lg text-black p-1 w-full h-10 rounded-l-xl border-2 border-roxo_input border-r-0 bg-lilas outline-roxo_input grow-1 ">12345678</p>
                <button type="submit" className=" px-1 bg-lilas  h-10  rounded-r-xl border-l-0  border-2 border-roxo_input border-l-0 "><img src="\assets\copy-icon"></img></button>
              </form>
            </div>
