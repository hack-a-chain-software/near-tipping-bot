...
export const HowToUse = () => {
  return (
    ...
    >
      ...
      <svg
        className="absolute top-[430px] left-0  z-40"
        width="180"
        height="600"
        viewBox="0 0 166 552"
        fill="none"
      ...
      >
        <path
          d="M-303.256 429.714C-345.109 374.079 -382.679 307.872 -368.546 239.666C-355.129 174.917 -286.981 144.377 -235.527 102.852C-183.637 60.9745 -138.659 -7.00511 -72.4589 0.71323C-6.33507 8.4227 20.8879 85.4979 62.3539 137.582C103.729 189.553 168.744 232.958 165.276 299.327C161.724 367.311 97.8617 411.455 45.7561 455.267C-8.33632 500.75 -63.7684 556.311 -134.219 551.153C-206.156 545.886 -259.892 487.357 -303.256 429.714Z"
          fill="#424250"
        />
      </svg>
      ...
      <div className="my-2/3 mx-6 lg:my-24 lg:mx-24 flex flex-col lg:block lg:grid lg:grid-cols-4 gap-12 ">
        <div className="items-center text-center z-50">
          ...
          <div className="bg-black bg-opacity-60 rounded-md p-8 h-5/6 drop-shadow-lg ">
            ...
            <p className="font-medium text-base px-2 text-center">
              {" "}
