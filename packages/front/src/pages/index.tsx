...
function Index() {
  return (
    <main className="bg-primary">
      ...
      <Divider>
        <Section id="tutorial" className="pt-24 pb-56">
          <div className="flex justify-center mb-16">
            <Title>
              Bot <HighlightText>tutorial</HighlightText>
            </Title>
          </div>
          ...
          <div>
            <iframe
              ...
              src="https://www.youtube.com/embed/FBPkdyliV1g?modestbranding=1&autohide=1&showinfo=0&controls=1"
            />
          </div>
        </Section>
      </Divider>
      ...
      <Section id="how-to-use" className="pt-24 pb-56">
        <div className="flex justify-center mb-16">
          <Title>
            How to <HighlightText>use</HighlightText>
          </Title>
        </div>
      ...
      <Section id="register-token" className="pt-32 pb-60">
        ...
        <div className="flex items-center justify-center ml-[-211px]">
          <img loading="lazy" src="/images/tipping_bot.png" alt="Tipping bot" />
